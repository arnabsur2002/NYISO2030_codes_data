...
warmset = load('scucfr_NYISO2030d_scores_2030_03_10(mean)');
cd ..
...
%if ~exist(output_dir, 'dir')
    ...
    mkdir('SCED_March_score_NYISO2030d_2030_03_10');  
%end
...
for jsel = 1:100													% scenario selected, 1 is base, cycle over these
    fprintf('==================================\n')
...
% 	mdi.UC.CommitSched = warmset.mdouc.UC.CommitSched;
    ...
    cd('SCED_March_score_NYISO2030d_2030_03_10')
